...
On average, the store located in CA generates $10.42 of revenue per impression or $758.82 of revenue per click. 
Compared to the store in NY ($2.59 of revenue per impression or $214.80 of revenue per click) and the store in TX ($0.57 of revenue per impression or $40.97 of revenue per click), 
CA has the highest return on revenue. 
